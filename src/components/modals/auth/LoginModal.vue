...
<template>
  <BaseLayout>
    <template v-slot:modal-child>
      <div
        class="h-full flex items-start justify-center lg:items-center md:items-center"
      >
        <div
          ...
          >
            <div class="p-4 mb-2 relative">
              <div class="flex justify-between">
                <div>
                  <div
                    class="text-left text-xl antialiased font-bold"
                  >
            ...
            <div class="py-3 mt-5">
              ...
              >
                We’ll send a code to your whatsapp to
                confirm your number. Standard message and
