...
<template>
  ...
  <div v-else class="rounded-md items-start justify-start flex-col transition ease-in-out delay-150 duration-300 absolute z-40 lg:right-0 w-auto h-screen bg-white flex p-2">

    <section class="flex items-center justify-start bg-white w-full gap-1 overflow-scroll hide-scroll-bar">
      <div class="">
        <svg @click="showFriendModal=false" width="24" height="30" viewBox="0 0 50 50" class="cursor-pointer hover:scale-105 ml-3" fill="none"
