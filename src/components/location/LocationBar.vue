...
<template>
  ...
  <div
    @click.stop="mapValue.show = !mapValue.show"
    class="transition-all ease-out delay-10 duration-100 bg-white cursor-pointer p-2 rounded-full shadow-sm flex items-center gap-2"
  >
    <MapPin
      width="24"
      color="#000"
    ...
    >
      <p
        ...
        @click="mapValue.isAddress = !mapValue.isAddress"
      >
        {{
          !mapValue?.isAddress
            ? "show address"
      ...
      <p class="text-sm font-light">
        {{
          !mapValue?.isAddress
            ...
            : userAddr
              ? userAddr
              : "We couldn't get your address details."
        }}
      </p>
    </div>
  </div>
